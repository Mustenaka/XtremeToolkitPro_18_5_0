...
{
	rcItem.DeflateRect(XTP_DPI_X(5), XTP_DPI_Y(8), XTP_DPI_X(5), XTP_DPI_Y(8));

	for (int y = rcItem.top, i = 0; y < rcItem.bottom; y += XTP_DPI_X(3), i++)
	{
		pDC->FillSolidRect(rcItem.left, y, (i + 1) % 5 == 0 ? rcItem.Width() / 2 : rcItem.Width(), XTP_DPI_Y(1), clrText);
	}
