...
int CMainFrame::OnCreate(LPCREATESTRUCT lpCreateStruct)
{
	...
	rcBar.OffsetRect(XTP_DPI_X(470), 0);
...
int CMainFrame::OnCreateControl(LPCREATECONTROLSTRUCT lpCreateControl)
{
	...
	if (lpCreateControl->nID == ID_BDR_NONE && pToolBar)
	{
		...
		pPopupBar->SetWidth(XTP_DPI_X(52 * 5 + 6));
		pPopupBar->SetTearOffPopup(_T("Borders"), IDR_BORDERS, XTP_DPI_X(52 * 5 + 6));
	...
	if (lpCreateControl->nID == ID_COMBO_SIZE && pToolBar && pToolBar->GetBarID() == IDR_FORMATBAR)
	{
		...
		pComboSize->SetWidth(XTP_DPI_X(80));
	...
	if (lpCreateControl->nID == ID_EDIT_UNDO && pToolBar)
	{
		...
		pUndoBar->SetBorders(XTP_DPI(CRect(2, 2, 2, 2)));
		...
		pControlListBox->SetWidth(XTP_DPI_X(140));
		...
		pControlListBoxInfo->SetWidth(XTP_DPI_X(140));
	...
	if (lpCreateControl->nID == ID_INSERT_COLUMNS)
	{
		...
		pColumnsBar->SetBorders(XTP_DPI(CRect(2, 2, 2, 2)));
	...
	if (lpCreateControl->nID == ID_INSERT_TABLE)
	{
		...
		pTableBar->SetBorders(XTP_DPI(CRect(2, 2, 2, 2)));
