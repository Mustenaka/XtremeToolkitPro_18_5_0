...
BEGIN_MESSAGE_MAP(CDialogSampleDlg, CDialogSampleDlgBase)
	...
	ON_COMMAND_RANGE(ID_THEME_OFFICE2000, ID_THEME_VISUALSTUDIO2005, OnTheme)
	ON_UPDATE_COMMAND_UI_RANGE(ID_THEME_OFFICE2000, ID_THEME_VISUALSTUDIO2005, OnUpdateTheme)
...
BOOL CDialogSampleDlg::OnInitDialog()
{
	...
	OnTheme(ID_THEME_VISUALSTUDIO2005);
	...
	CXTPRibbonTab* pTabBase = pRibbonBar->AddTab("Test");
