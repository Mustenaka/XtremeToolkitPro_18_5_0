...
BOOL CSampleDlg::OnInitDialog()
{
	...
	strConnectionString.Format(IDS_CONNECTION_STRING, strDatabasePath.operator LPCTSTR());
...
BOOL CSampleDlg::ShowRecords(CString strTableName)
{
	...
	try
	{
		...
		hr = m_pRecordset->put_CursorType(adOpenDynamic);
...
void CSampleDlg::OnAddRecordsToRecordset() 
{
	...
	m_wndRecordsReportCtrl.Populate();
}
