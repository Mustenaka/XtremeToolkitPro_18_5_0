...
BEGIN_MESSAGE_MAP(CReportSampleView, CXTPReportView)
	...
	ON_COMMAND(ID_TEST_ENSURE_VISIBLE,       OnTestEnsureVisible)
	ON_COMMAND(ID_TEST_COLUMNS,              OnTestColumns)
	ON_COMMAND(ID_TEST_EXPAND,               OnTestExpand)
...
#define IMPLEMENT_APPSKIN_MAP(ID,Skin)\
	ON_COMMAND(ID_VIEW_SKIN_##ID, OnViewSkin##Skin)\
	ON_UPDATE_COMMAND_UI(ID_VIEW_SKIN_##ID, OnUpdateViewSkin##Skin)

	IMPLEMENT_APPSKIN_MAP(NONE,None)
	IMPLEMENT_APPSKIN_MAP(OFFICE_2007,Office2007)
	IMPLEMENT_APPSKIN_MAP(OFFICE_2010,Office2010)
	IMPLEMENT_APPSKIN_MAP(VISTA,Vista)

#endif

	ON_COMMAND(ID_VIEW_THEME_THEMEDIALOG, OnViewThemeDialog)
...
int CReportSampleView::OnCreate(LPCREATESTRUCT lpCreateStruct)
{
	...
	CBitmap bmp;
	VERIFY(bmp.LoadBitmap(IDB_BMREPORT_16));
...
//	wndReport.SetImageList(&m_ilIcons);
	...
	wndReport.InitialSelectionEnable(FALSE);
	...
	// set the theme for the report control.
	CXTPReportView::SetTheme(xtpReportThemeOffice2013, TRUE);
	UpdateReportIcons();
	...
	m_dlgTheme.AddCustomTheme(xtpThemeDlgCustom+1, _T("Office 2003 (Luna)"), FALSE, 3);
	m_dlgTheme.AddCustomTheme(xtpThemeDlgCustom+2, _T("Explorer"));
	m_dlgTheme.AddCustomTheme(xtpThemeDlgCustom+3, _T("Test Paint Manager"));
	
	return 0;
}

void CReportSampleView::OnViewThemeDialog()
{
...
{
public:
	CPostRedraw(CWnd* pWnd) : m_pWnd(pWnd)
	{
	...
	~CPostRedraw()
	{
		...
		m_pWnd->RedrawWindow(0, 0, RDW_ALLCHILDREN|RDW_INVALIDATE|RDW_UPDATENOW);
	}
private:
	CWnd* m_pWnd;
};

LRESULT CReportSampleView::OnThemeChanged(WPARAM wParam, LPARAM lParam)
{
    ...
    case xtpThemeDlgOffice2000:
		{
			...
			CXTPReportView::SetTheme(xtpReportThemeDefault);
		}
		break;
    case xtpThemeDlgOfficeXP:
		{
			pMainFrame->SetTheme(xtpThemeOfficeXP);
			CXTPReportView::SetTheme(xtpReportThemeOfficeXP);
		}
		break;
    case xtpThemeDlgOffice2003:
		{
			pMainFrame->SetTheme(xtpThemeOffice2003);
			CXTPReportView::SetTheme(xtpReportThemeOffice2003);
		}
		break;
    case xtpThemeDlgOffice2007:
		{
			switch (nColor)
			{
			case xtpThemeColor2007Blue:   pMainFrame->SetTheme(xtpThemeResource, xtpIniOffice2007Blue);   break;
			case xtpThemeColor2007Silver: pMainFrame->SetTheme(xtpThemeResource, xtpIniOffice2007Silver); break;
			case xtpThemeColor2007Black:  pMainFrame->SetTheme(xtpThemeResource, xtpIniOffice2007Black);  break;
			case xtpThemeColor2007Aqua:   pMainFrame->SetTheme(xtpThemeResource, xtpIniOffice2007Aqua);   break;
			}

			CXTPReportView::SetTheme(xtpReportThemeResource);
		}
		break;
    case xtpThemeDlgOffice2010:
		{
			switch (nColor)
			{
			case xtpThemeColor2010Blue:   pMainFrame->SetTheme(xtpThemeResource, xtpIniOffice2010Blue);   break;
			case xtpThemeColor2010Silver: pMainFrame->SetTheme(xtpThemeResource, xtpIniOffice2010Silver); break;
			case xtpThemeColor2010Black:  pMainFrame->SetTheme(xtpThemeResource, xtpIniOffice2010Black);  break;
			}
    ...
    case xtpThemeDlgOffice2013:
		{
			...
			case xtpThemeColor2013White:
				{
					switch (nAccent)
					{
					case xtpThemeAccentAccess:     pMainFrame->SetTheme(xtpThemeOffice2013, xtpIniOffice2013Access);     break;
					case xtpThemeAccentExcel:      pMainFrame->SetTheme(xtpThemeOffice2013, xtpIniOffice2013Excel);      break;
					case xtpThemeAccentOneNote:    pMainFrame->SetTheme(xtpThemeOffice2013, xtpIniOffice2013OneNote);    break;
					case xtpThemeAccentOutlook:    pMainFrame->SetTheme(xtpThemeOffice2013, xtpIniOffice2013Outlook);    break;
					case xtpThemeAccentPowerPoint: pMainFrame->SetTheme(xtpThemeOffice2013, xtpIniOffice2013PowerPoint); break;
					case xtpThemeAccentPublisher:  pMainFrame->SetTheme(xtpThemeOffice2013, xtpIniOffice2013Publisher);  break;
					case xtpThemeAccentWord:       pMainFrame->SetTheme(xtpThemeOffice2013, xtpIniOffice2013Word);       break;
					}
				}
				break;
			case xtpThemeColor2013GrayLight:
				{
					switch (nAccent)
					{
					case xtpThemeAccentAccess:     pMainFrame->SetTheme(xtpThemeOffice2013, xtpIniOffice2013AccessGrayLight);     break;
					case xtpThemeAccentExcel:      pMainFrame->SetTheme(xtpThemeOffice2013, xtpIniOffice2013ExcelGrayLight);      break;
					case xtpThemeAccentOneNote:    pMainFrame->SetTheme(xtpThemeOffice2013, xtpIniOffice2013OneNoteGrayLight);    break;
					case xtpThemeAccentOutlook:    pMainFrame->SetTheme(xtpThemeOffice2013, xtpIniOffice2013OutlookGrayLight);    break;
					case xtpThemeAccentPowerPoint: pMainFrame->SetTheme(xtpThemeOffice2013, xtpIniOffice2013PowerPointGrayLight); break;
					case xtpThemeAccentPublisher:  pMainFrame->SetTheme(xtpThemeOffice2013, xtpIniOffice2013PublisherGrayLight);  break;
					case xtpThemeAccentWord:       pMainFrame->SetTheme(xtpThemeOffice2013, xtpIniOffice2013WordGrayLight);       break;
					}
				}
				break;
			case xtpThemeColor2013GrayDark:

				{
					switch (nAccent)
					{
					case xtpThemeAccentAccess:     pMainFrame->SetTheme(xtpThemeOffice2013, xtpIniOffice2013AccessGrayDark);     break;
					case xtpThemeAccentExcel:      pMainFrame->SetTheme(xtpThemeOffice2013, xtpIniOffice2013ExcelGrayDark);      break;
					case xtpThemeAccentOneNote:    pMainFrame->SetTheme(xtpThemeOffice2013, xtpIniOffice2013OneNoteGrayDark);    break;
					case xtpThemeAccentOutlook:    pMainFrame->SetTheme(xtpThemeOffice2013, xtpIniOffice2013OutlookGrayDark);    break;
					case xtpThemeAccentPowerPoint: pMainFrame->SetTheme(xtpThemeOffice2013, xtpIniOffice2013PowerPointGrayDark); break;
					case xtpThemeAccentPublisher:  pMainFrame->SetTheme(xtpThemeOffice2013, xtpIniOffice2013PublisherGrayDark);  break;
					case xtpThemeAccentWord:       pMainFrame->SetTheme(xtpThemeOffice2013, xtpIniOffice2013WordGrayDark);       break;
					}
				}
				break;
			}
			...
			case xtpThemeColor2016Black:
				{
					switch (nAccent)
					{
					case xtpThemeAccentAccess:     pMainFrame->SetTheme(xtpThemeOffice2013, xtpIniOffice2016AccessBlack);     break;
					case xtpThemeAccentExcel:      pMainFrame->SetTheme(xtpThemeOffice2013, xtpIniOffice2016ExcelBlack);      break;
					case xtpThemeAccentOneNote:    pMainFrame->SetTheme(xtpThemeOffice2013, xtpIniOffice2016OneNoteBlack);    break;
					case xtpThemeAccentOutlook:    pMainFrame->SetTheme(xtpThemeOffice2013, xtpIniOffice2016OutlookBlack);    break;
					case xtpThemeAccentPowerPoint: pMainFrame->SetTheme(xtpThemeOffice2013, xtpIniOffice2016PowerPointBlack); break;
					case xtpThemeAccentPublisher:  pMainFrame->SetTheme(xtpThemeOffice2013, xtpIniOffice2016PublisherBlack);  break;
					case xtpThemeAccentWord:       pMainFrame->SetTheme(xtpThemeOffice2013, xtpIniOffice2016WordBlack);       break;
					}
				}
				break;
			case xtpThemeColor2016White:
				{
					switch (nAccent)
					{
					case xtpThemeAccentAccess:     pMainFrame->SetTheme(xtpThemeOffice2013, xtpIniOffice2016AccessWhite);     break;
					case xtpThemeAccentExcel:      pMainFrame->SetTheme(xtpThemeOffice2013, xtpIniOffice2016ExcelWhite);      break;
					case xtpThemeAccentOneNote:    pMainFrame->SetTheme(xtpThemeOffice2013, xtpIniOffice2016OneNoteWhite);    break;
					case xtpThemeAccentOutlook:    pMainFrame->SetTheme(xtpThemeOffice2013, xtpIniOffice2016OutlookWhite);    break;
					case xtpThemeAccentPowerPoint: pMainFrame->SetTheme(xtpThemeOffice2013, xtpIniOffice2016PowerPointWhite); break;
					case xtpThemeAccentPublisher:  pMainFrame->SetTheme(xtpThemeOffice2013, xtpIniOffice2016PublisherWhite);  break;
					case xtpThemeAccentWord:       pMainFrame->SetTheme(xtpThemeOffice2013, xtpIniOffice2016WordWhite);       break;
					}
				}
				break;
			case xtpThemeColor2016Colorful:
				{
					switch (nAccent)
					{
					case xtpThemeAccentAccess:     pMainFrame->SetTheme(xtpThemeOffice2013, xtpIniOffice2016AccessColorful);     break;
					case xtpThemeAccentExcel:      pMainFrame->SetTheme(xtpThemeOffice2013, xtpIniOffice2016ExcelColorful);      break;
					case xtpThemeAccentOneNote:    pMainFrame->SetTheme(xtpThemeOffice2013, xtpIniOffice2016OneNoteColorful);    break;
					case xtpThemeAccentOutlook:    pMainFrame->SetTheme(xtpThemeOffice2013, xtpIniOffice2016OutlookColorful);    break;
					case xtpThemeAccentPowerPoint: pMainFrame->SetTheme(xtpThemeOffice2013, xtpIniOffice2016PowerPointColorful); break;
					case xtpThemeAccentPublisher:  pMainFrame->SetTheme(xtpThemeOffice2013, xtpIniOffice2016PublisherColorful);  break;
					case xtpThemeAccentWord:       pMainFrame->SetTheme(xtpThemeOffice2013, xtpIniOffice2016WordColorful);       break;
					}
				}
				break;
			case xtpThemeColor2016GrayDark:
				{
					switch (nAccent)
					{
					case xtpThemeAccentAccess:     pMainFrame->SetTheme(xtpThemeOffice2013, xtpIniOffice2016AccessDarkGray);     break;
					case xtpThemeAccentExcel:      pMainFrame->SetTheme(xtpThemeOffice2013, xtpIniOffice2016ExcelDarkGray);      break;
					case xtpThemeAccentOneNote:    pMainFrame->SetTheme(xtpThemeOffice2013, xtpIniOffice2016OneNoteDarkGray);    break;
					case xtpThemeAccentOutlook:    pMainFrame->SetTheme(xtpThemeOffice2013, xtpIniOffice2016OutlookDarkGray);    break;
					case xtpThemeAccentPowerPoint: pMainFrame->SetTheme(xtpThemeOffice2013, xtpIniOffice2016PowerPointDarkGray); break;
					case xtpThemeAccentPublisher:  pMainFrame->SetTheme(xtpThemeOffice2013, xtpIniOffice2016PublisherDarkGray);  break;
					case xtpThemeAccentWord:       pMainFrame->SetTheme(xtpThemeOffice2013, xtpIniOffice2016WordDarkGray);       break;
					}
				}
				break;
			}
    ...
    case xtpThemeDlgVisualStudio2015:
		{
			...
			switch (nColor)
			{
			case xtpThemeColor2015Blue:  pMainFrame->SetTheme(xtpThemeVisualStudio2015, xtpIniVisualStudio2015Blue);  break;
			case xtpThemeColor2015Dark:  pMainFrame->SetTheme(xtpThemeVisualStudio2015, xtpIniVisualStudio2015Dark);  break;
			case xtpThemeColor2015Light: pMainFrame->SetTheme(xtpThemeVisualStudio2015, xtpIniVisualStudio2015Light); break;
			}

			CXTPReportView::SetTheme(xtpReportThemeVisualStudio2015, TRUE);
		}
		break;
	case int(xtpThemeDlgCustom+1): // Office 2003 (Luna)
		{
			pMainFrame->SetTheme(xtpThemeOffice2003);
			CXTPReportView::SetTheme(xtpReportThemeOffice2003Luna);
		}
		break;
	case int(xtpThemeDlgCustom+2): // Explorer
		{
			pMainFrame->SetTheme(xtpThemeNativeWinXP);
			CXTPReportView::SetTheme(xtpReportThemeExplorer);
		}
		break;
	case int(xtpThemeDlgCustom+3): // Test Paint Manager
		{
			pMainFrame->SetTheme(xtpThemeOffice2000);
			GetReportCtrl().SetPaintManager(new CTestReportPaintManager());
		}
		break;
	}

	UpdateReportIcons();
	ShowReadOnlyLockIcons(m_bShowReadOnlyLockIcons);
...
void CReportSampleView::SetSkin(CReportSampleApp::AppSkin skin)
{
	// Set the theme to Office XP so it is obvious the skin has 
	// been applied to the application.
	OnThemeChanged(MAKEWPARAM(xtpThemeDlgOfficeXP,-1),MAKELPARAM(-1,-1));

	theApp.m_skin = skin;
	switch(skin)
	{
	case CReportSampleApp::skinNone:
		XTPSkinManager()->LoadSkin(NULL, NULL);
		break;
	case CReportSampleApp::skinOffice2007:
		VERIFY(XTPSkinManager()->LoadSkin(_T(".\\Styles\\Office2007.cjstyles")));
		break;
	case CReportSampleApp::skinOffice2010:
		VERIFY(XTPSkinManager()->LoadSkin(_T(".\\Styles\\Office2010.cjstyles")));
		break;
	case CReportSampleApp::skinVista:
		VERIFY(XTPSkinManager()->LoadSkin(_T(".\\Styles\\Vista.cjstyles")));
		break;
	}
}

#define IMPLEMENT_APPSKIN(Skin)\
	void CReportSampleView::OnViewSkin##Skin()\
	{\
		SetSkin(CReportSampleApp::skin##Skin);\
	}\
	void CReportSampleView::OnUpdateViewSkin##Skin(CCmdUI* pCmdUI)\
	{\
		pCmdUI->SetCheck(CReportSampleApp::skin##Skin == theApp.m_skin ? 1 : 0);\
	}

IMPLEMENT_APPSKIN(None)
IMPLEMENT_APPSKIN(Office2007)
IMPLEMENT_APPSKIN(Office2010)
IMPLEMENT_APPSKIN(Vista)

#endif

void CReportSampleView::ShowReadOnlyLockIcons(BOOL bShow)
{
	GetReportCtrl().GetPaintManager()->m_bShowLockIcon = bShow;
	//GetReportCtrl().GetPaintManager()->m_bUseShellIcon = bShow;
}

void CReportSampleView::UpdateReportIcons()
{
	CXTPReportControl* pWndReport = &GetReportCtrl();
	ASSERT_VALID(pWndReport);
	if (!pWndReport)
		return;

	pWndReport->GetImageManager()->RemoveAll();

	int dpi = XTPDpiHelper()->GetDPIX();

	switch (pWndReport->GetCurrentTheme())
	{
	case xtpReportThemeOffice2013:

		if(96 <= dpi && dpi < 120)
			VERIFY(pWndReport->GetImageManager()->SetIcons(IDB_BMREPORT2013_16, 0, 0, CSize(16, 16)));
		else if (120 <= dpi && dpi < 144)
			VERIFY(pWndReport->GetImageManager()->SetIcons(IDB_BMREPORT2013_20, 0, 0, CSize(20, 20)));
		else if (144 <= dpi && dpi < 192)
			VERIFY(pWndReport->GetImageManager()->SetIcons(IDB_BMREPORT2013_24, 0, 0, CSize(24, 24)));
		else
			VERIFY(pWndReport->GetImageManager()->SetIcons(IDB_BMREPORT2013_32, 0, 0, CSize(32, 32)));
	...
	case xtpReportThemeVisualStudio2015:
		{
			...
			{
				if(96 <= dpi && dpi < 120)
					VERIFY(pWndReport->GetImageManager()->SetIcons(IDB_BMREPORT_VS2015_DARK_16, 0, 0, CSize(16, 16)));
				else if (120 <= dpi && dpi < 144)
					VERIFY(pWndReport->GetImageManager()->SetIcons(IDB_BMREPORT_VS2015_DARK_20, 0, 0, CSize(20, 20)));
				else if (144 <= dpi && dpi < 192)
					VERIFY(pWndReport->GetImageManager()->SetIcons(IDB_BMREPORT_VS2015_DARK_24, 0, 0, CSize(24, 24)));
				else
					VERIFY(pWndReport->GetImageManager()->SetIcons(IDB_BMREPORT_VS2015_DARK_32, 0, 0, CSize(32, 32)));
			}
			else if (XTPResourceImages()->m_strIniFileName == xtpIniVisualStudio2015Light)
			{
				if(96 <= dpi && dpi < 120)
					VERIFY(pWndReport->GetImageManager()->SetIcons(IDB_BMREPORT_VS2015_LIGHT_16, 0, 0, CSize(16, 16)));
				else if (120 <= dpi && dpi < 144)
					VERIFY(pWndReport->GetImageManager()->SetIcons(IDB_BMREPORT_VS2015_LIGHT_20, 0, 0, CSize(20, 20)));
				else if (144 <= dpi && dpi < 192)
					VERIFY(pWndReport->GetImageManager()->SetIcons(IDB_BMREPORT_VS2015_LIGHT_24, 0, 0, CSize(24, 24)));
				else
					VERIFY(pWndReport->GetImageManager()->SetIcons(IDB_BMREPORT_VS2015_LIGHT_32, 0, 0, CSize(32, 32)));
			}
			else
			{
				if(96 <= dpi && dpi < 120)
					VERIFY(pWndReport->GetImageManager()->SetIcons(IDB_BMREPORT_VS2015_BLUE_16, 0, 0, CSize(16, 16)));
				else if (120 <= dpi && dpi < 144)
					VERIFY(pWndReport->GetImageManager()->SetIcons(IDB_BMREPORT_VS2015_BLUE_20, 0, 0, CSize(20, 20)));
				else if (144 <= dpi && dpi < 192)
					VERIFY(pWndReport->GetImageManager()->SetIcons(IDB_BMREPORT_VS2015_BLUE_24, 0, 0, CSize(24, 24)));
				else
					VERIFY(pWndReport->GetImageManager()->SetIcons(IDB_BMREPORT_VS2015_BLUE_32, 0, 0, CSize(32, 32)));
			}
		}
		break;
	...
	default:
		...
		if(96 <= dpi && dpi < 120)
			VERIFY(pWndReport->GetImageManager()->SetIcons(IDB_BMREPORT_16, 0, 0, CSize(16, 16)));
		else if (120 <= dpi && dpi < 144)
			VERIFY(pWndReport->GetImageManager()->SetIcons(IDB_BMREPORT_20, 0, 0, CSize(20, 20)));
		else if (144 <= dpi && dpi < 192)
			VERIFY(pWndReport->GetImageManager()->SetIcons(IDB_BMREPORT_24, 0, 0, CSize(24, 24)));
		else
			VERIFY(pWndReport->GetImageManager()->SetIcons(IDB_BMREPORT_32, 0, 0, CSize(32, 32)));
...
void CReportSampleView::OnReportMarkup()
{
	...
	pMarkupContext = GetReportCtrl().GetMarkupContext();
...
void CReportSampleView::OnReportColumnRClick(NMHDR * pNotifyStruct, LRESULT * /*result*/)
{
	...
	if (nMenuResult > ID_COLUMN_ALIGMENT_TEXT && nMenuResult < ID_COLUMN_ALIGMENT_ICON)
	{
		...
		int nHeadAlign = pColumn->GetHeaderAlignment();
		nHeadAlign &= ~(xtpColumnTextLeft | xtpColumnTextCenter | xtpColumnTextRight);
		
		nHeadAlign |= xtpColumnTextWordBreak;

		switch (nMenuResult)
		{
			case ID_COLUMN_ALIGMENT_LEFT :
				pColumn->SetAlignment(nAlign | xtpColumnTextLeft);
				pColumn->SetHeaderAlignment(nHeadAlign | xtpColumnTextLeft);
				break;
			case ID_COLUMN_ALIGMENT_RIGHT :
				pColumn->SetAlignment(nAlign | xtpColumnTextRight);
				pColumn->SetHeaderAlignment(nHeadAlign | xtpColumnTextRight);
				break;
			case ID_COLUMN_ALIGMENT_CENTER  :
				pColumn->SetAlignment(nAlign | xtpColumnTextCenter);
				pColumn->SetHeaderAlignment(nHeadAlign | xtpColumnTextCenter);
				break;
		}
...
void CReportSampleView::OnTestEnsureVisible()
{
	CTestEnsureVisibleDlg dlgEnsureVisible;
	dlgEnsureVisible.DoModal();
}

void CReportSampleView::OnTestColumns()
{
	CTestColumnsDlg dlgColumns;
	dlgColumns.DoModal();
}

void CReportSampleView::OnTestExpand()
{
	CTestExpandDlg dlgExpand;
	dlgExpand.DoModal();
}
...
void CReportSampleView::AddSampleRecords()
{
	...
	strSubject = _T("Message waiting your approval...");
	...
	strFrom = _T("Bruce Banner [bbanner@codejock.com]");
	strMessage = _T("The MSDN Visual Studio 2015 Library also provides information on the tools and technologies available with the Visual Studio suite.");
	strSubject = _T("Informational tools and technologies");
	...
	strSubject = _T("Download GDI+ latest version");
	...
	strSubject = _T("Available features");
	...
	strFrom = _T("Codejock");
	strSubject = _T("[Codejock] Newsletter");
	...
	strFrom = _T("Codejock Software") + strForumLink;
	...
	strFrom = _T("Codejock Team");
	strSubject = _T("Codejock Sitewide update");
	strMessage = _T("You have acquired this Codejock update because you requested to be on the list. Honest! An explanation is at the bottom of this email, and also info on how to be extracted from the list.");
	...
	strFrom = _T("Codejock Software");
	strSubject = _T("Comment Added: Using a resource dll");
	...
	strSubject = _T("Comment Added: Fabulous looking report control! This is brilliant!");
	...
	strFrom = _T("Codejock Software");
	strSubject = _T("Codejock Software:  Lost Member Name or Password");
	strMessage = _T("You are receiving this email because you reported that you could not remember your Codejock Software Member Name or password.");
	...
	strFrom = _T("Codejock");
	strSubject = _T("New projects available on Codejock");
	strMessage = _T("New projects are now available for the following on Codejock! * Mathematical and Computer Modelling");
	...
	strSubject = _T("info");
	strMessage = _T("OR-Library is a collection of test data sets for a variety of problem areas. These test data sets can be accessed via emailing to Codejock a message containing the name of the required file, or via ftp/WWW using the addresses given at the bottom of this file.");
...
BOOL CReportSampleView::OnFindInReport()
{
	...
	if (pItem)
	{
		sOut.Format(_T("R=%d C=%d %s"), pItem->GetRecord()->GetIndex(), pItem->GetIndex(), pItem->GetCaption(NULL));
		AfxMessageBox(sIn + _T(" <- ExactStart -> ") + sOut);
		pItem->SetTextColor(RGB(255,0,0));
	}
	else
		AfxMessageBox(sIn + _T(" <- ExactStart -> Not Found"));

	sIn = _T("James HOWLETT");
	...
	{
		sOut.Format(_T("R=%d C=%d %s"), pItem->GetRecord()->GetIndex(), pItem->GetIndex(), pItem->GetCaption(NULL));
		AfxMessageBox(sIn + _T(" <- ByRows|ExactStart -> ") + sOut);
		pItem->SetTextColor(RGB(255,0,0));
	}
	else
		AfxMessageBox(sIn + _T(" <- ByRows|ExactStart -> Not Found"));
	...
	{
		sOut.Format(_T("R=%d C=%d %s"), pItem->GetRecord()->GetIndex(), pItem->GetIndex(), pItem->GetCaption(NULL));
		AfxMessageBox(sIn + _T(" <- MatchCase -> ") + sOut);
		pItem->SetTextColor(RGB(255,0,0));
	}
	else
		AfxMessageBox(sIn + _T(" <- MatchCase -> Not Found"));
	...
	if (pItem)
	{
		...
		AfxMessageBox(sIn + _T(" <- ExactPhrase -> ") + sOut);
		pItem->SetTextColor(RGB(255,0,0));
	}
	else
		AfxMessageBox(sIn + _T(" <- ExactPhrase -> Not Found"));

	sIn = _T("ruce W");
	pItem = wndReport.GetRecords()->FindRecordItem(0, iRows - 1, 0, iCols - 1, iR, iC + 1, 
		sIn, 0);
