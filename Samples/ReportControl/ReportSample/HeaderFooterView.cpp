...
//	ON_COMMAND_RANGE(ID_REPORTCONTROL_THEME_OFFICE2003, OnReportControlTheme)

	ON_COMMAND(ID_REPORTCONTROL_THEME_OFFICE2003,     OnThemeOffice2003)
	ON_COMMAND(ID_REPORTCONTROL_THEME_OFFICEXP,       OnThemeOfficeXP)
	ON_COMMAND(ID_REPORTCONTROL_THEME_EXPLORER,   OnThemeExplorer)
	ON_COMMAND(ID_REPORTCONTROL_THEME_OFFICE2003LUNA, OnThemeOffice2003Luna)

	ON_UPDATE_COMMAND_UI(ID_REPORTCONTROL_THEME_OFFICE2003,     OnUpdateThemeOffice2003)
	ON_UPDATE_COMMAND_UI(ID_REPORTCONTROL_THEME_OFFICEXP,       OnUpdateThemeOfficeXP)
	ON_UPDATE_COMMAND_UI(ID_REPORTCONTROL_THEME_EXPLORER,   OnUpdateThemeExplorer)
	ON_UPDATE_COMMAND_UI(ID_REPORTCONTROL_THEME_OFFICE2003LUNA, OnUpdateThemeOffice2003Luna)
...
#define CONCOLUMN_STYLE(Style)	\
	void CHeaderFooterView::OnTheme##Style()\
	{\
		GetReportCtrl().SetTheme(xtpReportTheme##Style);\
	}\
	void CHeaderFooterView::OnUpdateTheme##Style(CCmdUI* pCmdUI)\
	{\
		pCmdUI->Enable(TRUE); \
		pCmdUI->SetCheck(GetReportCtrl().GetCurrentTheme() == xtpReportTheme##Style); \
	}

CONCOLUMN_STYLE(OfficeXP)
CONCOLUMN_STYLE(Explorer)
CONCOLUMN_STYLE(Office2003)
CONCOLUMN_STYLE(Office2003Luna)
...
#if defined(_XTP_INCLUDE_CALENDAR) && !defined(_XTP_EXCLUDE_CALENDAR)
