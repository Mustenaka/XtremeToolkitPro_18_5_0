...
public:
	...
	BOOL m_bShowReadOnlyLockIcons;
	void ShowReadOnlyLockIcons(BOOL bShow);
...
protected:
	...
	afx_msg void OnTestEnsureVisible();
	afx_msg void OnTestColumns();
	afx_msg void OnTestExpand();
...
#define DECLARE_APPSKIN(Skin)\
	afx_msg void OnViewSkin##Skin();\
	afx_msg void OnUpdateViewSkin##Skin(CCmdUI* pCmdUI);

	DECLARE_APPSKIN(None)
	DECLARE_APPSKIN(Office2007)
	DECLARE_APPSKIN(Office2010)
	DECLARE_APPSKIN(Vista)
...
#if defined(_XTP_INCLUDE_SKINFRAMEWORK) && !defined(_XTP_EXCLUDE_SKINFRAMEWORK)
	void SetSkin(CReportSampleApp::AppSkin skin);
#endif
	void UpdateReportIcons();
};
