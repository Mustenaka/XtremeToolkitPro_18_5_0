...
#if !defined(_GRIDSAMPLEVIEW_H_)
#define _GRIDSAMPLEVIEW_H_

#if _MSC_VER > 1000
#pragma once
#endif // _MSC_VER > 1000

class CGridSampleDoc;

class CGridSampleView : public CXTPReportView
{
protected: // create from serialization only
	CGridSampleView();
	DECLARE_DYNCREATE(CGridSampleView)
...
inline CGridSampleDoc* CGridSampleView::GetDocument()
{
	return DYNAMIC_DOWNCAST(CGridSampleDoc, m_pDocument);
}
#endif

//{{AFX_INSERT_LOCATION}}

#endif // !defined(_GRIDSAMPLEVIEW_H_)
