...
BOOL CTrackControlDlg::OnInitDialog()
{
	...
	m_dlgTheme.ExcludeTheme(
		...
		XTP_EXCLUDE_THEME_OFFICE2007       | 
		XTP_EXCLUDE_THEME_OFFICE2010       |
	...
	// set startup theme.
	OnThemeChanged(MAKEWPARAM(LOWORD(xtpThemeDlgOffice2016),HIWORD(xtpThemeColor2016Black)),
		MAKELPARAM(LOWORD(xtpThemeAccentOutlook),HIWORD(-1)));
