...
LRESULT CChildWnd::OnGetTabColor(WPARAM, LPARAM)
{
...
void CChildWnd::OnSelectColor(UINT nColor)
{
	m_nColor = nColor - ID_COLOR_BLUE + xtpTabColorBlue;
}

void CChildWnd::OnUpdateSelectColor(CCmdUI* pCmdUI)
{
	pCmdUI->SetCheck((int)pCmdUI->m_nID - ID_COLOR_BLUE == m_nColor - xtpTabColorBlue);

}

void CChildWnd::OnSelectColorNone()
{
	m_nColor = RGB(255, 255, 255);
}

void CChildWnd::OnUpdateSelectColorNone(CCmdUI* pCmdUI)
{
