...
BEGIN_MESSAGE_MAP(CMainFrame, CMDIFrameWnd)
	...
	ON_COMMAND(ID_VIEW_THEME_VISUALSTUDIO2005, OnViewThemeVisualStudio2005)
	...
	ON_UPDATE_COMMAND_UI(ID_VIEW_THEME_VISUALSTUDIO2005, OnUpdateViewThemeVisualStudio2005)
	ON_WM_CLOSE()
...
void CMainFrame::OnViewThemeVisualStudio2005()
{
...
void CMainFrame::OnUpdateViewThemeVisualStudio2005(CCmdUI* pCmdUI)
{
	pCmdUI->SetCheck(XTPPaintManager()->GetCurrentTheme() == xtpThemeVisualStudio2005);
}
