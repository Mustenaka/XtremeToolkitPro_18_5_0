...
{
	{ _T("Name"),       XTP_DPI_X(200), LVCFMT_LEFT},
	{ _T("Type"),       XTP_DPI_X(100), LVCFMT_LEFT},
	{ _T("Modified"),   XTP_DPI_X(120), LVCFMT_LEFT},
	{ _T("Size"),        XTP_DPI_X(80), LVCFMT_RIGHT},
	{ _T("Ratio"),       XTP_DPI_X(70), LVCFMT_RIGHT},
	{ _T("Packed"),     XTP_DPI_X(100), LVCFMT_RIGHT},
	{ _T("Attributes"),  XTP_DPI_X(90), LVCFMT_LEFT},
	{ _T("Path"),       XTP_DPI_X(200), LVCFMT_LEFT}
};

struct file_info
{
	LPSTR info[_countof(columns)];
};
