...
BOOL CMainFrame::CreateMiniToolBar()
{
	...
	pMiniToolBar->SetWidth(XTP_DPI_X(23) * 7);
...
BOOL CMainFrame::CreateRibbonBar()
{
	...
	pComboFont->SetDropDownListStyle();
	pComboFont->EnableAutoComplete();
	pComboFont->SetWidth(XTP_DPI_X(130));
...
int CMainFrame::OnCreateControl(LPCREATECONTROLSTRUCT lpCreateControl)
{
	...
	if (lpCreateControl->nID == ID_BDR_NONE && pToolBar)
	{
		...
		pPopupBar->SetWidth(XTP_DPI_X(23) * 5 + XTP_DPI_X(6));
		pPopupBar->SetTearOffPopup(_T("Borders"), IDR_BORDERS, XTP_DPI_X(23) * 5 + XTP_DPI_X(6));
