...
void CItemTreeView::OnWindowPosChanged(WINDOWPOS FAR* lpwndpos)
{
	...
	{
		::SetWindowPos(m_wndCaption.m_hWnd, NULL, 0, 0, lpwndpos->cx - XTP_DPI_X(2), XTP_DPI_Y(19),
			SWP_NOZORDER | SWP_NOACTIVATE );
	}
	if( ::IsWindow( m_wndTreeCtrl.m_hWnd ) )
	{
		::SetWindowPos(m_wndTreeCtrl.m_hWnd, NULL, 0, XTP_DPI_Y(19), lpwndpos->cx - XTP_DPI_X(2), lpwndpos->cy - XTP_DPI_Y(21),
			SWP_NOZORDER | SWP_NOACTIVATE );
	}
}
