...
int CMainFrame::OnCreate(LPCREATESTRUCT lpCreateStruct)
{
	...
	CXTPDockingPane* pPaneNavigator = m_paneManager.CreatePane(
		ID_PANE_NAVIGATOR, XTP_DPI(CRect(0, 0, 220, 120)), xtpPaneDockLeft);

	CXTPDockingPane* pPaneTasks = m_paneManager.CreatePane(
		ID_PANE_TASKS, XTP_DPI(CRect(0, 0, 220, 120)), xtpPaneDockTop, pPaneNavigator);

	CXTPDockingPane* pPaneOutline = m_paneManager.CreatePane(
		ID_PANE_OUTLINE, XTP_DPI(CRect(0, 0, 220, 120)), xtpPaneDockLeft, pPaneNavigator);

	m_paneManager.AttachPane(pPaneTasks, pPaneNavigator);
	m_paneManager.AttachPane(pPaneOutline, pPaneNavigator);

	m_paneManager.CreatePane(ID_PANE_BOOKMARKS, XTP_DPI(CRect(0, 0, 220, 120)), xtpPaneDockBottom, pPaneNavigator);
