...
/////////////////////////////////////////////////////////////////////////////
// CPaneViewSolution window

class CPaneViewSolution : public CPaneWnd
{
public:
	CPaneViewSolution();
	virtual ~CPaneViewSolution();

	CXTPTreeCtrl m_wndSolutionView;
	CXTPImageList m_ilSolutionView;
	CXTPToolBar m_wndToolBar;

	//{{AFX_VIRTUAL(CPaneViewSolution)
	//}}AFX_VIRTUAL

protected:
	virtual void RefreshMetrics(AppTheme nTheme);

	//{{AFX_MSG(CPaneViewSolution)
