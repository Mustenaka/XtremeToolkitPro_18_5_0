...
public:
	...
	CPaneViewClass m_wndClassView;
	CPaneViewResource m_wndResourceView;
	CPaneViewSolution m_wndSolutionExplorer;
	CPaneViewProperties m_wndProperties;
	CPaneViewOutput m_wndOutput;
	CPaneViewTaskPanel m_wndPaneViewTaskPanel;
...
protected:
	...
	void AdjustTreeFrames(BOOL bAdjust);
