...
/////////////////////////////////////////////////////////////////////////////
// CPaneViewResource window

class CPaneViewResource : public CPaneWnd
{
public:
	CPaneViewResource();
	virtual ~CPaneViewResource();

	CXTPTreeCtrl m_wndResourceView;
	CXTPImageList m_ilResourceView;

	//{{AFX_VIRTUAL(CPaneViewResource)
	//}}AFX_VIRTUAL

protected:
	virtual void RefreshMetrics(AppTheme nTheme);

	//{{AFX_MSG(CPaneViewResource)
