	...
	case themeVS2012Dark:
		{
			...
			m_clrBack       = XTPIniColor(_T("DockingPane.Inactive"), _T("CaptionColor"),    ::GetSysColor(COLOR_WINDOW));
			m_clrBorderLite = XTPIniColor(_T("DockingPane.Tabs"),     _T("ButtonSelected"),  ::GetSysColor(COLOR_WINDOW));
			m_clrBorderDark = XTPIniColor(_T("DockingPane.Tabs"),     _T("ButtonSelected"),  ::GetSysColor(COLOR_3DSHADOW));
		}
		break;
