...
void CMainFrame::OnGreenTheme()
{
	...
	CXTPPaintManager::SetCustomTheme(new CXTPCommandBarsThemeMsMoney(RGB(152, 185, 158), RGB(108, 156, 120), RGB(136, 174, 144), RGB(93, 145, 106)));
...
void CMainFrame::OnRedTheme()
{
	...
	CXTPPaintManager::SetCustomTheme(new CXTPCommandBarsThemeMsMoney(RGB(201, 160, 156), RGB(179, 120, 116), RGB(193, 145, 141), RGB(171, 106, 102)));
	GetCommandBars()->GetPaintManager()->m_bAutoResizeIcons = TRUE;
	GetCommandBars()->GetCommandBarsOptions()->SetDPIScallingOptions(TRUE);
	GetCommandBars()->RedrawCommandBars();
}
...
void CMainFrame::OnBlueTheme()
{
	...
	CXTPPaintManager::SetCustomTheme(new CXTPCommandBarsThemeMsMoney(RGB(140, 163, 196), RGB(91, 125, 173), RGB(122, 149, 187), RGB(74, 111, 165)));
	GetCommandBars()->GetPaintManager()->m_bAutoResizeIcons = TRUE;
	GetCommandBars()->GetCommandBarsOptions()->SetDPIScallingOptions(TRUE);
	GetCommandBars()->RedrawCommandBars();
}
