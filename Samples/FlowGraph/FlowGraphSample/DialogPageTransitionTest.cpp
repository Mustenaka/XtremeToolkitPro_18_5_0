...
void CDialogPageTransitionTest::CreateTable1Page()
{
	...
	pNode->SetLocation(XTP_DPI(CPoint(50, 50)));
	pNode->SetID(ID_NODE_DATABASE1);

	pNode->AddNamedConnectionPoints(_T("Table 1"), xtpFlowGraphPointInputAndOutput);
	pNode->AddNamedConnectionPoints(_T("Table 2"), xtpFlowGraphPointInputAndOutput);
	...
	pNode->SetLocation(XTP_DPI(CPoint(200, 150)));

	pNode->AddNamedConnectionPoints(_T("Item 1"), xtpFlowGraphPointInputAndOutput);
	pNode->AddNamedConnectionPoints(_T("Item 2"), xtpFlowGraphPointInputAndOutput);
	pNode->AddNamedConnectionPoints(_T("Item 3"), xtpFlowGraphPointInputAndOutput);

	CXTPFlowGraphConnection* pConnection;
	pConnection = pPageTable->GetConnections()->AddConnection(new CXTPFlowGraphConnection());
	pConnection->SetInputPoint(pPageTable->GetNodes()->GetAt(0)->GetConnectionPoints()->FindConnectionPoint(_T("Table 2"), xtpFlowGraphPointInput));
	pConnection->SetOutputPoint(pPageTable->GetNodes()->GetAt(2)->GetConnectionPoints()->FindConnectionPoint(_T("Item 1"), xtpFlowGraphPointOutput));
	
	pConnection = pPageTable->GetConnections()->AddConnection(new CXTPFlowGraphConnection());
	pConnection->SetInputPoint(pPageTable->GetNodes()->GetAt(0)->GetConnectionPoints()->FindConnectionPoint(_T("Table 1"), xtpFlowGraphPointInput));
	pConnection->SetOutputPoint(pPageTable->GetNodes()->GetAt(1)->GetConnectionPoints()->FindConnectionPoint(_T("Item 1"), xtpFlowGraphPointOutput));
}
...
void CDialogPageTransitionTest::CreateTable2Page()
{
	...
	pNode->SetColor(clrOfficeColors[1]);
	pNode->SetLocation(XTP_DPI(CPoint(300, -100)));
	pNode->SetID(ID_NODE_DATABASE2);

	pNode->AddNamedConnectionPoints(_T("Table 1"), xtpFlowGraphPointInputAndOutput);
	pNode->AddNamedConnectionPoints(_T("Table 2"), xtpFlowGraphPointInputAndOutput);
	pNode->AddNamedConnectionPoints(_T("Table 3"), xtpFlowGraphPointInputAndOutput);
	...
	pNode->SetLocation(XTP_DPI(CPoint(400, 50)));

	pNode->AddNamedConnectionPoints(_T("Item 1"), xtpFlowGraphPointInputAndOutput);
	pNode->AddNamedConnectionPoints(_T("Item 2"), xtpFlowGraphPointInputAndOutput);
	pNode->AddNamedConnectionPoints(_T("Item 3"), xtpFlowGraphPointInputAndOutput);
	pNode->AddNamedConnectionPoints(_T("Item 4"), xtpFlowGraphPointInputAndOutput);

	CXTPFlowGraphConnection* pConnection;
	pConnection = pPageTable->GetConnections()->AddConnection(new CXTPFlowGraphConnection());
	pConnection->SetInputPoint(pPageTable->GetNodes()->GetAt(1)->GetConnectionPoints()->FindConnectionPoint(_T("Item 1"), xtpFlowGraphPointInput));
	pConnection->SetOutputPoint(pPageTable->GetNodes()->GetAt(2)->GetConnectionPoints()->FindConnectionPoint(_T("Item 2"), xtpFlowGraphPointOutput));
}
...
void CDialogPageTransitionTest::CreateDatabasePage()
{
	...
	pConnection->SetInputPoint(pPageDatabase->GetNodes()->GetAt(0)->GetConnectionPoints()->FindConnectionPoint(_T("Table 1"), xtpFlowGraphPointInput ));
	pConnection->SetOutputPoint(pPageDatabase->GetNodes()->GetAt(1)->GetConnectionPoints()->FindConnectionPoint(_T("Table 2"), xtpFlowGraphPointOutput ));
}
