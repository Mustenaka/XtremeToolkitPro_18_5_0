...
BOOL CDialogPerfomanceTest::OnInitDialog()
{
	...
	for (i = 1; i <= 500; i++)
	{
		...
		pNode->AddNamedConnectionPoints(_T("Item 1"), xtpFlowGraphPointOutput);
		pNode->AddNamedConnectionPoints(_T("Item 2"), xtpFlowGraphPointInput);
	}
