	...
	CCreateContext* pContext)
{
	...
	if (!m_wndSplitter.CreateView(0, 0, RUNTIME_CLASS(CSearchOptionsPane), XTP_DPI(CSize(270, 100)), pContext) ||
		!m_wndSplitter.CreateView(0, 1, RUNTIME_CLASS(CSearchOptionsView), XTP_DPI(CSize(100, 100)), pContext))
	{
