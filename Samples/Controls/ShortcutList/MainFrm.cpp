...
BOOL CMainFrame::OnCreateClient(LPCREATESTRUCT /*lpcs*/, CCreateContext* pContext)
{
	...
	if (!m_wndSplitter.CreateView(0, 0, RUNTIME_CLASS(CShortcutListBoxView), XTP_DPI_SIZE(CSize(100, 100)), pContext) ||
		!m_wndSplitter.CreateView(0, 1, RUNTIME_CLASS(CShortcutListView), XTP_DPI_SIZE(CSize(100, 100)), pContext))
	{
