...
BOOL CFlatHeaderDlg::OnInitDialog()
{
	...
	m_listCtrl.InsertColumn(0, _T("Column One"), LVCFMT_LEFT, XTP_DPI_X(125));
	m_listCtrl.InsertColumn(1, _T("Column Two"), LVCFMT_LEFT, XTP_DPI_X(125));
	m_listCtrl.InsertColumn(2, _T("Column Three"), LVCFMT_LEFT, XTP_DPI_X(125));
