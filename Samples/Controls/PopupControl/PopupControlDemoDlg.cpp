...
BOOL CPopupControlDemoDlg::OnInitDialog()
{
	...
	AddListItem(_T("Office 2013 Style"), xtpPopupThemeOffice2013, TRUE);
	...
	AddListItem(_T("Custom Codejock Message"), xtpPopupThemeCodejock);
		...
		case xtpPopupThemeOfficeXP:
			{
				...
				m_uShowDelay = 3000;
				m_nTrans = 255;
				m_sizePopup = XTP_DPI(CSize(170, 130));
			}
			break;
		...
		case xtpPopupThemeOffice2013:
			{
				...
				m_uShowDelay = 3000;
				m_nTrans = 200;
				m_sizePopup = XTP_DPI(CSize(329, 74));
			}
			break;
		...
		case xtpPopupThemeTooltip:
			{
				...
				m_uShowDelay = 3000;
				m_nTrans = 255;
				m_sizePopup = XTP_DPI(CSize(220, 90));
			}
			break;
		...
		case xtpPopupThemeLayer:
			{
				...
				m_uShowDelay = 1500;
				m_nTrans = 255;
				m_sizePopup = XTP_DPI(CSize(156, 161));
			}
			break;
		case xtpPopupThemeCodejock:
			{
				...
				m_uShowDelay = 2500;
				m_nTrans = 255;
				m_sizePopup = XTP_DPI(CSize(250, 200));
			}
			break;
	}
...
void CPopupControlDemoDlg::SetDefaultTheme(CXTPPopupControl* pPopup)
{
	...
	CXTPPopupItem* pItemText = (CXTPPopupItem*)pPopup->AddItem(
		new CXTPPopupItem(CRect(XTP_DPI_X(25), XTP_DPI_Y(5), m_sizePopup.cx, XTP_DPI_Y(19)), _T("Word 2000 Theme")));
	...
	pItemText = (CXTPPopupItem*)pPopup->AddItem(
		new CXTPPopupItem(CRect(XTP_DPI_X(104), XTP_DPI_Y(30), m_sizePopup.cx, XTP_DPI_Y(45)), _T("Parameters")));

	pItemText = (CXTPPopupItem*)pPopup->AddItem(
		new CXTPPopupItem(XTP_DPI(CRect(65, 90, 105, 110)), _T("OK")));
...
void CPopupControlDemoDlg::SetOfficeXPTheme(CXTPPopupControl* pPopup)
{
	...
	CXTPPopupItem* pItemText = (CXTPPopupItem*)pPopup->AddItem(
		new CXTPPopupItem(CRect(XTP_DPI_X(25), XTP_DPI_Y(5), m_sizePopup.cx, XTP_DPI_Y(19)), _T("Word XP Theme")));
	pItemText->SetTextAlignment(DT_LEFT);
	pItemText->CalculateHeight();
	pItemText->CalculateWidth();
	pItemText->SetHyperLink(FALSE);
...
void CPopupControlDemoDlg::SetMSNTheme(CXTPPopupControl* pPopup)
{
	...
	// add caption icon.
	CXTPPopupItem* pItemIcon = (CXTPPopupItem*)pPopup->AddItem(
		new CXTPPopupItem(XTP_DPI(CRect(7, 6, 20, 19))));
	pItemIcon->SetIcons(IDB_CAPTIONMSN, 0, xtpPopupItemIconNormal);
	pItemIcon->SetButton(FALSE);

	// add caption text.
	CXTPPopupItem* pItemText = (CXTPPopupItem*)pPopup->AddItem(
		new CXTPPopupItem(CRect(XTP_DPI_X(25), XTP_DPI_Y(6), m_sizePopup.cx - XTP_DPI_X(25), XTP_DPI_Y(19)), _T("Popup Control Demo")));
	...
	// add close button
	pItemIcon = (CXTPPopupItem*)pPopup->AddItem(
		new CXTPPopupItem(CRect(m_sizePopup.cx - XTP_DPI_X(19), XTP_DPI_Y(6), m_sizePopup.cx - XTP_DPI_X(6), XTP_DPI_Y(19))));
	...
	int y = XTP_DPI_Y(27);
	pItemText = (CXTPPopupItem*)pPopup->AddItem(
		new CXTPPopupItem(CRect(m_sizePopup.cx - XTP_DPI_X(66), y, m_sizePopup.cx - XTP_DPI_X(10), XTP_DPI_Y(25)), _T("Options")));
	...
	y += sizeText.cy + XTP_DPI_Y(5);

	pItemText = (CXTPPopupItem*)pPopup->AddItem(
		new CXTPPopupItem(CRect(XTP_DPI_X(5), y, m_sizePopup.cx - XTP_DPI_X(5), XTP_DPI_Y(25)), _T("Please visit our website for additional product information including registration details.")));
	...
	pItemIcon = (CXTPPopupItem*)pPopup->AddItem(
		new CXTPPopupItem(CRect(m_sizePopup.cx - XTP_DPI_X(55), y, m_sizePopup.cx - XTP_DPI_X(10), y + XTP_DPI_Y(18))));
	pItemIcon->SetIcons(IDB_LOGOMSN, 0, xtpPopupItemIconNormal);

	// adjust window height.
	m_sizePopup.cy = y + XTP_DPI_Y(18) + XTP_DPI_Y(10);
...
void CPopupControlDemoDlg::SetOffice2003Theme(CXTPPopupControl* pPopup)
{
	...
	// add text items.
	CXTPPopupItem* pItemText = (CXTPPopupItem*)pPopup->AddItem(
		new CXTPPopupItem(XTP_DPI(CRect(46, 16, 270, 41)), _T("Peter Parker")));
	pItemText->SetBold(TRUE);

	pItemText = (CXTPPopupItem*)pPopup->AddItem(
		new CXTPPopupItem(XTP_DPI(CRect(46, 29, 270, 54)), _T("RE: Week reports 12/04/2004 - 17/04/2004")));
	pItemText->SetHyperLink(FALSE);

	pItemText = (CXTPPopupItem*)pPopup->AddItem(
		new CXTPPopupItem(XTP_DPI(CRect(46, 42, 270, 92)), _T("See comments below.\nThanks.")));
	pItemText->SetHyperLink(FALSE);
	...
	// letter icon.
	CXTPPopupItem* pItemIcon = (CXTPPopupItem*)pPopup->AddItem(
		new CXTPPopupItem(XTP_DPI(CRect(5, 12, 17, 24))));
	pItemIcon->SetIcon(IDI_LETTER);
	pItemIcon->SetButton(FALSE);

	// close icon.
	pItemIcon = (CXTPPopupItem*)pPopup->AddItem(
		new CXTPPopupItem(XTP_DPI(CRect(308, 14, 324, 30))));
	...
	// flag icon.
	pItemIcon = (CXTPPopupItem*)pPopup->AddItem(
		new CXTPPopupItem(XTP_DPI(CRect(4, 49, 20, 65))));
	pItemIcon->SetIcon(IDI_FLAG);
	pItemIcon->SetButton(TRUE);

	// cross icon.
	pItemIcon = (CXTPPopupItem*)pPopup->AddItem(
		new CXTPPopupItem(XTP_DPI(CRect(23, 49, 39, 65))));
...
void CPopupControlDemoDlg::SetOffice2013Theme(CXTPPopupControl* pPopup)
{
	pPopup->RemoveAllItems();
	...
	CXTPPopupItem* pItemText = (CXTPPopupItem*)pPopup->AddItem(
		new CXTPPopupItem(XTP_DPI(CRect(46, 16, 270, 41)), _T("Peter Parker")));
	pItemText->SetBold(TRUE);
	//pItemText->SetTextColor(RGB(42,110,183));

	pItemText = (CXTPPopupItem*)pPopup->AddItem(
		new CXTPPopupItem(XTP_DPI(CRect(46, 29, 320, 54)), _T("Issue With Post on Codejock Developer Community")));
	pItemText->SetHyperLink(FALSE);

	pItemText = (CXTPPopupItem*)pPopup->AddItem(
		new CXTPPopupItem(XTP_DPI(CRect(46, 42, 270, 92)), _T("Hi, \nThe following report has been submitted by")));
	pItemText->SetHyperLink(FALSE);
	...
	// minimize icon.
	pItemIcon = (CXTPPopupItem*)pPopup->AddItem(
		new CXTPPopupItem(XTP_DPI(CRect(290, 14, 306, 30))));
	pItemIcon->SetIcon(IDI_MINIMIZE);
	pItemIcon->SetButton(TRUE);
	pItemIcon->SetID(ID_POPUP_CLOSE);
	...
	pPopup->SetTheme(xtpPopupThemeOffice2013);
	pPopup->RedrawControl();
}
...
void CPopupControlDemoDlg::SetColorTheme(CXTPPopupControl* pPopup, CXTPPopupPaintManager* pPaintManager)
{
	...
	// add caption text.
	CXTPPopupItem* pItemText = (CXTPPopupItem*)pPopup->AddItem(
		new CXTPPopupItem(CRect(XTP_DPI_X(5), 0, m_sizePopup.cx - XTP_DPI_X(5), XTP_DPI_Y(25)), _T("Message for You")));
	...
	pItemIcon = (CXTPPopupItem*)pPopup->AddItem(
		new CXTPPopupItem(CRect(XTP_DPI_X(12), y, XTP_DPI_X(44), y + XTP_DPI_Y(32))));

	pItemIcon->SetIcon(IDI_LETTER2);

	// add message text.
	y += XTP_DPI_Y(32) + XTP_DPI_Y(5);

	pItemText = (CXTPPopupItem*)pPopup->AddItem(
		new CXTPPopupItem(CRect(XTP_DPI_X(10), y, m_sizePopup.cx - XTP_DPI_X(10), XTP_DPI_Y(25)), _T("Please visit our website for additional product information including registration details.")));
	...
	pItemText = (CXTPPopupItem*)pPopup->AddItem(
		new CXTPPopupItem(CRect(m_sizePopup.cx - XTP_DPI_X(71), y, m_sizePopup.cx - XTP_DPI_X(15), XTP_DPI_Y(25)), _T("more...")));
	...
	// adjust popup height.
	sizeText = pItemText->GetRect().Size();
	m_sizePopup.cy = y + sizeText.cy + XTP_DPI_Y(10);
...
void CPopupControlDemoDlg::SetTooltipTheme(CXTPPopupControl* pPopup)
{
	...
	pPopup->AddItem(new CXTPPopupItem(
		XTP_DPI(CRect(0, 0, 220, 90)), NULL, RGB(255, 255, 225), 0));

	CXTPPopupItem* pItemText = (CXTPPopupItem*)pPopup->AddItem(
		new CXTPPopupItem(XTP_DPI(CRect(20, 30, 200, 100)), _T("Please visit our website for additional product information including registration details.")));
	pItemText->SetTextAlignment(DT_CENTER|DT_WORDBREAK);
	pItemText->SetID(ID_GOTO_SITE);

	pItemText = (CXTPPopupItem*)pPopup->AddItem(
		new CXTPPopupItem(CRect(XTP_DPI_X(5), 0, m_sizePopup.cx, XTP_DPI_Y(25)), _T("Codejock Information")));
	pItemText->SetTextAlignment(DT_LEFT|DT_SINGLELINE| DT_VCENTER);
	pItemText->SetBold(TRUE);
	pItemText->SetHyperLink(FALSE);

	CXTPPopupItem* pItemIcon = (CXTPPopupItem*)pPopup->AddItem(
		new CXTPPopupItem(XTP_DPI(CRect(220 - 20, 2, 220 - 2, 2 + 18))));
...
void CPopupControlDemoDlg::SetRTFTheme(CXTPPopupControl* pPopup) 
{
	...
	CXTPPopupItem* pItemText = (CXTPPopupItem*)pPopup->AddItem(new CXTPPopupItem(XTP_DPI(CRect(8, 12, 500, 130))));
	...
	// close icon.
	CXTPPopupItem* pItemIcon = (CXTPPopupItem*)pPopup->AddItem(
		new CXTPPopupItem(CRect(sizePopup.cx + XTP_DPI_X(2), XTP_DPI_Y(10), sizePopup.cx + XTP_DPI_X(2) + XTP_DPI_X(16), XTP_DPI_Y(10) + XTP_DPI_Y(16))));
	...
	m_sizePopup.cx = sizePopup.cx + XTP_DPI_X(20);
	m_sizePopup.cy = sizePopup.cy + XTP_DPI_Y(20);
...
void CPopupControlDemoDlg::SetMarkupTheme(CXTPPopupControl* pPopup) 
{
	...
	// close icon.
	CXTPPopupItem* pItemIcon = (CXTPPopupItem*)pPopup->AddItem(
		new CXTPPopupItem(CRect(sizePopup.cx + XTP_DPI_X(10), XTP_DPI_Y(10), sizePopup.cx + XTP_DPI_X(10) + XTP_DPI_X(16), XTP_DPI_Y(10) + XTP_DPI_X(16))));
	...
	m_sizePopup.cx = sizePopup.cx + XTP_DPI_X(30);
	m_sizePopup.cy = sizePopup.cy + XTP_DPI_Y(20);
...
void CPopupControlDemoDlg::SetCodejockTheme(CXTPPopupControl* pPopup) 
{
	...
	// add caption text.
	CXTPPopupItem* pItemText = (CXTPPopupItem*)pPopup->AddItem(
		new CXTPPopupItem(CRect(XTP_DPI_X(5), 0, m_sizePopup.cx, XTP_DPI_Y(25)), _T("Codejock Update Available")));
	...
	// add options link.
	pItemText = (CXTPPopupItem*)pPopup->AddItem(
		new CXTPPopupItem(CRect(XTP_DPI_X(15), cy, m_sizePopup.cx - XTP_DPI_X(15), XTP_DPI_Y(25)), _T("Options")));
	...
	CSize sizeText = pItemText->GetRect().Size();
	cy += pItemText->GetRect().Size().cy + XTP_DPI_Y(25);

	// add message text.
	pItemText = (CXTPPopupItem*)pPopup->AddItem(
		new CXTPPopupItem(CRect(XTP_DPI_X(15), cy, m_sizePopup.cx - XTP_DPI_X(15), XTP_DPI_Y(25)), _T("Click here to learn more about this update, and how you can download our latest product version.")));
	...
	// add codejock logo
	CXTPPopupItem* pItemIcon = (CXTPPopupItem*)pPopup->AddItem(
		new CXTPPopupItem(CRect(XTP_DPI_X(10), cy, m_sizePopup.cx - XTP_DPI_X(10), cy + XTP_DPI_Y(26))));

	pItemIcon->SetIcons(IDB_LOGOCODEJOCK, 0, xtpPopupItemIconNormal);

	// add close button
	pItemIcon = (CXTPPopupItem*)pPopup->AddItem(
		new CXTPPopupItem(CRect(m_sizePopup.cx - XTP_DPI_X(82), cy + XTP_DPI_Y(2), m_sizePopup.cx - XTP_DPI_X(10), cy + XTP_DPI_Y(22))));
	...
	m_sizePopup.cy = cy + XTP_DPI_Y(36);
...
void CPopupThemeColorBlue::DrawBackground(CDC* pDC, CXTPPopupControl* pControl, CRect rcClient)
{
	...
	rcClient.DeflateRect(XTP_DPI(CRect(5,25,5,5)));
