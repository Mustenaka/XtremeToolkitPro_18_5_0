...
// Construction
public:
	CExcelTabProperties(BOOL& bBottom, BOOL& bHasArrows, BOOL& bHasHomeEnd, BOOL& bHScroll, BOOL& bSquareTabs, CExcelTabView* pParent);   // standard constructor
...
protected:
	...
	afx_msg void OnSquareTabs();
	afx_msg void OnChkLargeTabs();
	//}}AFX_MSG
	DECLARE_MESSAGE_MAP()
};
