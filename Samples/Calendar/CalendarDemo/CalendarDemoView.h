...
protected:
	...
	BOOL IsNotRecurring(CXTPCalendarEvent* pEvent);
	...
	void OnEvent_Calendar(XTP_NOTIFY_CODE idEvent, WPARAM wParam, LPARAM lParam);
	
	void OnEvent_IsEditActionDisabled(XTP_NOTIFY_CODE idEvent, WPARAM wParam, LPARAM lParam);
	void OnEvent_BeforeEditAction(XTP_NOTIFY_CODE idEvent, WPARAM wParam, LPARAM lParam);
	void OnEvent_PrePopulate(XTP_NOTIFY_CODE idEvent, WPARAM wParam, LPARAM lParam);
	
	void OnEventSelChanged(XTP_NOTIFY_CODE idEvent, WPARAM wParam, LPARAM lParam);
		
	void OnEvent_CalendarData(XTP_NOTIFY_CODE idEvent, WPARAM wParam, LPARAM lParam);
	void OnReminders(XTP_NOTIFY_CODE idEvent, WPARAM wParam , LPARAM lParam);
	void OnBeforeDrawThemeObject(XTP_NOTIFY_CODE idEvent, WPARAM wParam , LPARAM lParam);
	void OnEvent_GetItemText(XTP_NOTIFY_CODE idEvent, WPARAM wParam , LPARAM lParam);
...
//MD
	afx_msg void OnCategories(UINT nStyle);
	afx_msg void OnCalendarMeetingOpen();
	afx_msg void OnCalendarMeetingDelete();
	afx_msg void OnCalendarMeetingPrivate();
	afx_msg void OnCalendarMeetingMeeting();
	afx_msg void OnCalendarMeetingReminder();
	afx_msg void OnUpdateCalendarMeetingPrivate(CCmdUI *pCmdUI);
	afx_msg void OnUpdateCalendarMeetingMeeting(CCmdUI *pCmdUI);
	afx_msg void OnUpdateCalendarMeetingReminder(CCmdUI *pCmdUI);
	afx_msg void OnAddTestCategory();
	afx_msg void OnUpdateAddTestCategory(CCmdUI *pCmdUI);

	CXTPCalendarEvent* GetSelEvent();
	...
	void SetTheme(XTPCalendarTheme nTheme);
	void OnFilePrintPreview();

	int m_nScale;
	BOOL m_bTestCategory;
