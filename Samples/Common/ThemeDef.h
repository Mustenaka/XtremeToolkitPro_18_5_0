...
// Parameters:
//      nTheme:  LOWORD(wParam) - Enumeration that identifies which theme was
//               selected.
//
//      nColor:  HIWORD(wParam) - Enumeration that identifies which color if
...
//
//      nAccent: LOWORD(lParam) - Enumeration that identifies which style if
...
//               If the value is -1, then no color was defined.
//
//      nBack:   HIWORD(lParam) - Enumeration that identifies which background
...
#define ON_WM_XTP_THEMECHANGED() \
	{ 0xC000, 0, 0, 0, reinterpret_cast<UINT_PTR>(&WM_XTP_THEMECHANGED), \
