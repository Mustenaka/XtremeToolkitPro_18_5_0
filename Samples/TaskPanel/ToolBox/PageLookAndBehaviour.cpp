...
BOOL CPageLookAndBehaviour::OnInitDialog()
{
	...
	m_comboTheme.AddString(_T("xtpTaskPanelThemeVisualStudio2003"));
	m_comboTheme.AddString(_T("xtpTaskPanelThemeVisualStudio2005"));
	...
	m_comboTheme.AddString(_T("xtpTaskPanelThemeShortcutBarOffice2007"));//xtpTaskPanelThemeResource
	m_comboTheme.AddString(_T("xtpTaskPanelThemeVisualStudio2010"));
	m_comboTheme.AddString(_T("xtpTaskPanelThemeVisualStudio2012Light"));
	m_comboTheme.AddString(_T("xtpTaskPanelThemeVisualStudio2012Dark"));
	m_comboTheme.AddString(_T("xtpTaskPanelThemeOffice2013"));
...
void CPageLookAndBehaviour::OnSelchangeComboTheme()
{
	...
	XTPTaskPanelPaintTheme themeCurrent = static_cast<XTPTaskPanelPaintTheme>(m_comboTheme.GetCurSel());
	...
	CXTPPaintManager::SetTheme(
		...
		themeCurrent == xtpTaskPanelThemeVisualStudio2003 ? xtpThemeOfficeXP:
		themeCurrent == xtpTaskPanelThemeVisualStudio2005 ? xtpThemeOfficeXP:
