...
void CGalleryItemThemeFonts::Draw(CDC* pDC, CXTPControlGallery* pGallery, CRect rcItem, BOOL bEnabled, BOOL bSelected, BOOL bPressed, BOOL bChecked)
{
	...
	CRect rcPreview(rcItem.left + XTP_DPI_X(6), rcItem.top + XTP_DPI_Y(6), rcItem.left + XTP_DPI_X(6) + XTP_DPI_X(43), rcItem.bottom - XTP_DPI_Y(6));
...
CGalleryItemFontColor::CGalleryItemFontColor(COLORREF clr, LPCTSTR lpszCaption, BOOL bTopMargin /*= TRUE*/, BOOL bBotttomMargin /*= TRUE*/)
{
	...
	SetSize(XTP_DPI_SIZE(CSize(17, 13 + (bTopMargin ? 2 : 0) + (bBotttomMargin ? 2 : 0))));
}
...
void CGalleryItemFontColor::Draw(CDC* pDC, CXTPControlGallery* /*pGallery*/, CRect rcItem, BOOL /*bEnabled*/, BOOL bSelected, BOOL /*bPressed*/, BOOL bChecked)
{
	...
	{
		if (m_bTopMargin) pDC->FillSolidRect(rcItem.left, rcItem.top, rcItem.Width(), XTP_DPI_X(1), RGB(197, 197, 197));
		pDC->FillSolidRect(rcItem.left, rcItem.top, XTP_DPI_X(1), rcItem.Height(), RGB(197, 197, 197));
		pDC->FillSolidRect(rcItem.right - 1, rcItem.top, XTP_DPI_X(1), rcItem.Height(), RGB(197, 197, 197));
