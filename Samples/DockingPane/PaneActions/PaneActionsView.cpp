...
int CPaneActionsView::OnCreate(LPCREATESTRUCT lpCreateStruct)
{
	...
	wndList.InsertColumn(0, _T("Action"), LVCFMT_LEFT, XTP_DPI_X(300));
	wndList.InsertColumn(1, _T("Pane"), LVCFMT_LEFT, XTP_DPI_X(100));
	wndList.InsertColumn(2, _T("Cancelable"), LVCFMT_CENTER, XTP_DPI_X(100));
	wndList.InsertColumn(3, _T("Canceled"), LVCFMT_CENTER, XTP_DPI_X(100));
