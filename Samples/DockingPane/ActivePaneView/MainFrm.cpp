...
int CMainFrame::OnCreate(LPCREATESTRUCT lpCreateStruct)
{
	...
	CXTPDockingPane* pwndPane1 = m_paneManager.CreatePane(
		IDR_PANE_OPTIONS, XTP_DPI(CRect(0, 0,200, 120)), xtpPaneDockLeft);
	CXTPDockingPane* pwndPane2 = m_paneManager.CreatePane(
		IDR_PANE_PROPERTIES, XTP_DPI(CRect(0, 0, 200, 120)), xtpPaneDockBottom, pwndPane1);
	m_paneManager.CreatePane(
		IDR_PANE_DIALOG, XTP_DPI(CRect(0, 0, 200, 120)), xtpPaneDockBottom, pwndPane2);
