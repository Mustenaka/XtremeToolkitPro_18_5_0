...
int CMainFrame::OnCreate(LPCREATESTRUCT lpCreateStruct)
{
	...
	CXTPDockingPane* pPaneExplorer = m_paneManager.CreatePane(
		IDR_PANE_EXPLORER, XTP_DPI(CRect(0, 0,250, 120)), xtpPaneDockLeft);

	m_paneManager.CreatePane(
		IDR_PANE_ICONS, XTP_DPI(CRect(0, 0, 200, 120)), xtpPaneDockBottom, pPaneExplorer);

	CXTPDockingPane* pPaneTools = m_paneManager.CreatePane(
		IDR_PANE_TOOLS, XTP_DPI(CRect(0, 0, 100, 200)), xtpPaneDockRight);

	m_paneManager.CreatePane(
		IDR_PANE_COLORS, XTP_DPI(CRect(0, 0, 100, 100)), xtpPaneDockBottom, pPaneTools);
