...
void CPaneColorSet::RefreshMetrics(XTPDockingPanePaintTheme nTheme)
{
	...
	case xtpPaneThemeOffice2013:
		{
			m_clrText       = XTPIniColor(_T("DockingPane.Inactive"), _T("TextColor"),       RGB( 43,  87, 154));
			m_clrBack       = XTPIniColor(_T("DockingPane.Inactive"), _T("BackgroundColor"), RGB(255, 255, 255));
			m_clrBorderLite = m_clrBack;
			m_clrBorderDark = m_clrBack;
		}
		break;		
	case xtpPaneThemeVisualStudio2012:
		{
			m_clrText       = XTPIniColor(_T("DockingPane.Inactive"), _T("TextColor"),       RGB( 68,  68,  68));
			m_clrBack       = XTPIniColor(_T("DockingPane.Inactive"), _T("BackgroundColor"), RGB(246, 246, 246));
			m_clrBorderLite = XTPIniColor(_T("DockingPane.Tabs"),     _T("ButtonSelected"),  RGB(246, 246, 246));
			m_clrBorderDark = XTPIniColor(_T("DockingPane.Tabs"),     _T("ButtonSelected"),  RGB(246, 246, 246));
		}
		break;
	case xtpPaneThemeVisualStudio2015:
		{
			...
			m_clrBack       = XTPIniColor(_T("DockingPane.Inactive"), _T("BackgroundColor"), RGB(246, 246, 246));
			m_clrBorderLite = XTPIniColor(_T("DockingPane.Tabs"),     _T("ButtonSelected"),  RGB(246, 246, 246));
			m_clrBorderDark = XTPIniColor(_T("DockingPane.Tabs"),     _T("ButtonBorder"),    RGB(204, 206, 219));
		}
		break;		
	default:
		{
