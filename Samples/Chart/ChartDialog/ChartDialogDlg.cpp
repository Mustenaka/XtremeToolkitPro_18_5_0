...
#define PIE_LABEL_POS xtpChartPieLabelOutside
...
void CChartDialogDlg::AddSeries()
{
	...
	pSeries->GetPoints()->Add(new CXTPChartSeriesPoint(1, 2, 2))->m_bSpecial = TRUE;
	pSeries->GetPoints()->Add(new CXTPChartSeriesPoint(2, 1.5, 1.5));
	pSeries->GetPoints()->Add(new CXTPChartSeriesPoint(3, 2.5, 2.5));
	pSeries->GetPoints()->Add(new CXTPChartSeriesPoint(4, 1, 1))->m_bSpecial = TRUE;
	pSeries->GetPoints()->Add(new CXTPChartSeriesPoint(5, 0.25, 0.25))->m_bSpecial = TRUE;
...
void CChartDialogDlg::OnChangeComboStyle() 
{
	...
	case 8:
		{
			CXTPChartPieSeriesStyle* pPieStyle = (CXTPChartPieSeriesStyle*)pSeries->SetStyle(new CXTPChart2dPieSeriesStyle());
			pPieStyle->SetRotation(20);
			pPieStyle->SetHolePercent(60);
			pPieStyle->SetExplodedDistancePercent(20);
			((CXTPChartPieSeriesLabel*)pPieStyle->GetLabel())->SetPosition(PIE_LABEL_POS);
		}
		break;
	case 9:
		{
