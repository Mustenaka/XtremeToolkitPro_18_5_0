...
double CALLBACK GetSinPointValue(CXTPChartSeries* /*pSeries*/, double x)
{
	return sin(x);
}

double CALLBACK GetCosPointValue(CXTPChartSeries* /*pSeries*/, double x)
{
	return cos(x);
}
