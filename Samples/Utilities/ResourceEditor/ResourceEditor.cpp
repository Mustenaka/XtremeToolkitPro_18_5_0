...
BOOL CResourceEditorApp::InitInstance()
{
	...
	{
		CString strTranslatingPath = m_strTranslatingPath + _T("ToolkitPro.ResourceEn.xml");
		if (FILEEXISTS_S(strTranslatingPath))
		{
			cmdInfo.m_nShellCommand = CCommandLineInfo::FileOpen;
			cmdInfo.m_strFileName = strTranslatingPath;
		}
		else
		{
