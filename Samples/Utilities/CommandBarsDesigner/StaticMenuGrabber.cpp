...
void CStaticMenuGrabber::OnPaint() 
{
	...
	if (m_bGrabbing)
	{
		rc.left += XTP_DPI_X(5) + XTP_DPI_X(32) + XTP_DPI_X(5);
	...
	{
		::DrawIconEx(dc, rc.left + XTP_DPI_X(5), rc.CenterPoint().y - XTP_DPI_X(32/2), 
			m_hCursor, XTP_DPI_X(32), XTP_DPI_X(32), 0, 0, DI_NORMAL);
