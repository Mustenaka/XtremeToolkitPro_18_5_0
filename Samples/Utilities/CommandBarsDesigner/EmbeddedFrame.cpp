...
// Load Docking Position and Controls
	...
	// Rectangle
	PX_Rect(&secOptions, _T("RectTracker"), m_pHostView->m_rectTracker.m_rect, XTP_DPI(CRect(10, 10, 310, 289)));
...
void CEmbeddedFrame::SetTheme(XTPPaintTheme theme)
{
	...
	{
		EnableFrameTheme(theme == xtpThemeResource || theme == xtpThemeRibbon ? GetCommandBars() : NULL);
	}
}
