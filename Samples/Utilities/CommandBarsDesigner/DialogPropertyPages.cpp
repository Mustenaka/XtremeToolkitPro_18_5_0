...
LPCTSTR lpThemes[] = { _T("xtpThemeOffice2000"), _T("xtpThemeOfficeXP"), _T("xtpThemeOffice2003") , 
	_T("xtpThemeNativeWinXP"), _T("xtpThemeVisualStudio2005"), _T("xtpThemeResource"), _T("xtpThemeRibbon"), _T("xtpThemeVisualStudio2008") };
...
void CDialogPropertyPages::CreateGridGeneral()
{
	...
	m_wndGridGeneral.SetTheme(xtpGridThemeVisualStudio2005);
...
void CDialogPropertyPages::CreateGridPaint()
{
	...
	m_wndGridPaint.SetTheme(xtpGridThemeVisualStudio2005);
