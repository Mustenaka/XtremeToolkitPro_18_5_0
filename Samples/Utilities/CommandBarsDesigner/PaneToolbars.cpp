...
void CPaneToolbars::RecalcLayout()
{
	...
	{
		nVerbsHeight = XTP_DPI_Y(50);
		m_wndPropertyGrid.ShowWindow(SW_SHOWNOACTIVATE);
		m_wndPropertyGrid.MoveWindow(0, rc.Height() - nVerbsHeight + XTP_DPI_Y(3), 
			rc.Width(), nVerbsHeight - XTP_DPI_Y(3));
	}
...
void CPaneToolbars::OnPanetoolbarsAddRibbon()
{
	...
	m_pActiveCommandBars->DockCommandBar(pRibbonBar, XTP_DPI(CRect(0, 0, 10, 10)), pDockBar);
