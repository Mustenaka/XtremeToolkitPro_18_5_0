...
int CMainFrame::OnCreate(LPCREATESTRUCT lpCreateStruct)
{
	...
	CXTPDockingPane* pPaneToolbars = m_paneManager.CreatePane(
		IDR_PANE_TOOLBARS, XTP_DPI(CRect(0, 0,200, 120)), xtpPaneDockRight);

	CXTPDockingPane* pPaneControls = m_paneManager.CreatePane(
		IDR_PANE_CONTROLS, XTP_DPI(CRect(0, 0, 200, 120)), xtpPaneDockRight);

	m_paneManager.AttachPane(pPaneControls, pPaneToolbars);

	m_paneManager.CreatePane(
		IDR_PANE_PROPERTIES, XTP_DPI(CRect(0, 0, 200, 120)), xtpPaneDockBottom, pPaneToolbars);

	CXTPDockingPane* pPaneAccelerators = m_paneManager.CreatePane(
		IDR_PANE_ACCELERATORS, XTP_DPI(CRect(0, 0, 200, 120)), xtpPaneDockLeft);

	CXTPDockingPane* pPaneIcons= m_paneManager.CreatePane(
		IDR_PANE_ICONS, XTP_DPI(CRect(0, 0, 200, 120)), xtpPaneDockLeft, pPaneAccelerators);

	CXTPDockingPane* pPaneLibrary = m_paneManager.CreatePane(
		IDR_PANE_LIBRARY, XTP_DPI(CRect(0, 0, 200, 120)), xtpPaneDockBottom, pPaneIcons);
