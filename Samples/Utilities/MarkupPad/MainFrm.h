...
protected:
	...
	afx_msg void OnSmoothingModeApplyToText();
	afx_msg void OnUpdateSmoothingModeApplyToText(CCmdUI *pCmdUI);
	afx_msg void OnSmoothingMode(UINT nCommand);
	afx_msg void OnUpdateSmoothingMode(CCmdUI* pCmdUI);
	//}}AFX_MSG
	LRESULT OnDockingPaneNotify(WPARAM wParam, LPARAM lParam);

	DECLARE_MESSAGE_MAP()

	void UpdateMarkupViews();
};
